...
function Header() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        const response = await axios.get(`https://4fdb-103-141-189-170.ngrok-free.app/user-details/${username}`, {
  ...
  const handleLogout = () => {
    stopInactivityTimer();
    axios.post("https://4fdb-103-141-189-170.ngrok-free.app/logout", {}, {
