...
function Header() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        const response = await axios.get(`https://d142-103-141-189-170.ngrok-free.app/user-details/${username}`, {
  ...
  const handleLogout = () => {
    stopInactivityTimer();
    axios.post("https://d142-103-141-189-170.ngrok-free.app/logout", {}, {
